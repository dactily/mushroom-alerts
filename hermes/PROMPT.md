...
Память: после каждого запуска сохраняй одну строку вида
  «грибы YYYY-MM-DD: Valmez=средняя, Bystrice=средняя, окно с 22.9»
и сравнивай с ней на следующий день. Держи только последнюю строку.
